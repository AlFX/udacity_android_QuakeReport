...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, List<Earthquake>> {
        ...
        * completed. It receives as input the return value from the doInBackground()
        * method. First we clear out the adapter, toe get rid of earthquake data from
        * a previous query to USGS. Then we update the adapter with the new list of
        * earthquakes, which will trigger the ListView to re-populate its list items.*/
        @Override
        protected void onPostExecute(List<Earthquake> data) {
            ...
            /* If there is a valid list of Earthquakes, the add them to the adapter's
