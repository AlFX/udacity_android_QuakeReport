...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject root = new JSONObject(SAMPLE_JSON_RESPONSE);                 /*convert String to JSONObject*/
            JSONArray featuresArray = root.getJSONArray("features");                /*extract features array from the JSONObject*/
            for (int i =0; i < featuresArray.length(); i++){                        /*loop through each item*/
                ...
                String url = properties.getString("url");                       /*get website to be opened via intent*/

                earthquakes.add(new Earthquake(mag, place, time, url));         /*create a new earthquake object that will populate the ArrayList*/
            }
